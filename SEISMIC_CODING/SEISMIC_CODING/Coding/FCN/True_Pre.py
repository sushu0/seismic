...
# ****************** 文件路径配置 ******************
SEISMIC_PATH = r'C:/Users/ZYH/Desktop/python_code/SEISMIC_CODING/Data/ShiJi/Real_20001.segy'
# SEISMIC_PATH = r'C:/Users/ZYH/Desktop/python_code/SEISMIC_CODING/Data/Hu6/20Hz.segy'
MODEL_PATH = 'C:\\Users\\ZYH\\Desktop\\python_code\\SEISMIC_CODING\\Model\\Hu6\\FCN_20Hz\\FCN_20Hz_model_10.pth'
NORM_PARAMS_PATH = 'C:/Users/ZYH/Desktop/python_code/SEISMIC_CODING/Data/Hu6/FCN_20Hz/norm_params_10.json'
OUTPUT_DIR = r'C:\Users\ZYH\Desktop\python_code\SEISMIC_CODING\Data\Hu6\output_images_10'
...
def load_data_with_metadata(path):
    ...
    with segyio.open(path, "r", ignore_geometry=True, strict=False) as f:
        seismic = np.stack([np.copy(f.trace[i]) for i in range(430)])
