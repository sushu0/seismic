# -*- coding: utf-8 -*-
"""
ThinLayerNet V3 - 30Hz 薄层反演训练 (优化版)
改进内容：
...
class Config:
    ...
    MIN_THIN_THICKNESS = 6   # 最小薄层厚度(采样点)
    MAX_THIN_THICKNESS = 35  # 最大薄层厚度(采样点) - 30Hz分辨率中等
